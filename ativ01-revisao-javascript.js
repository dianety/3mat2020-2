...
let densidade = (area, pop) => pop/area
...
*/
for (let i=0; i<9; i++){
    let densEstado = densidade(estadosNe[i].area,estadosNe[i].populacao)
    estadosNe[i]["densidade demográfica"] = densEstado
...
let ex4 = objeto => {
    for (let propriedade in objeto){
        console.log('Atributo: ' + propriedade + " Valor: " + objeto[propriedade])
    }
}
